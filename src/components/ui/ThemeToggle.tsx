 ...
 * Uses next-themes hook to manage theme state
 */
export function ThemeToggle() {
  ...
  return (
    <div className="flex items-center">
      <div className="bg-gray-100 dark:bg-blue-950 rounded-lg p-1 flex space-x-1">
        <button
          onClick={() => setTheme('light')}
          className={`p-1.5 rounded-md transition-colors ${
            theme === 'light'
              ? 'bg-white dark:bg-blue-900 shadow-sm'
